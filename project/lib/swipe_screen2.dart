...
class Swipe2 extends StatefulWidget {
  ...
  @override
  State<Swipe2> createState() => _Swipe2State();
}
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage("assets/images/Swipe2.png"),
                fit: BoxFit.cover)),
        child: Stack(
          children: [
            Padding(
            ...
            Container(
              ...
              child: Text(
                ...
                style: GoogleFonts.abrilFatface(
                    textStyle:
                        TextStyle(fontSize: 26, color: Color(0xffFE2550))),
              ),
            ),
            Container(
              ...
              child: Text(
                "Tailored",
                style: GoogleFonts.abrilFatface(
                    textStyle: TextStyle(fontSize: 46, color: Colors.white)),
              ),
            ),
            Container(
              alignment: Alignment(-0.60, 0.52),
              child: Text(
                "Jennifer Kingstey exploring the \n new range of winter fashion wear",
